...
export default class SortView extends AbstractView {
  ...
  #sortTypeChangeHandler = (evt) => {
    ...
    if (evt.target.tagName !== 'LABEL' || !currentInput.hasAttribute('data-sort-type')) {
      return;
    }

    this._callback.sortTypeChange(currentInput.dataset.sortType);
    this.#addCheckedAttributeHandler(inputs, currentInput);
  };

  #addCheckedAttributeHandler = (inputs, currentInput) => {
